 ...
 * Based on schema: course table with fields (id, course_code, course_name,
 * course_description, student_count, created_at, is_active)
 */
@Repository
public interface CourseRepository extends JpaRepository<Course, Long> {
        ...
        // Relationship: measure.courseIndicator_id -> course_indicator.id,
        // course_indicator.course_id -> course.id
