...
------------------------------------------------------------
-- CLONE SEMESTER 2 (Spring 2024) COURSE STRUCTURE
-- INTO FALL 2023 (1), FALL 2024 (3), SPRING 2025 (4)
------------------------------------------------------------
...
-- FALL 2023
INSERT INTO course (course_code, course_name, course_description, semester_id, student_count, is_active)
SELECT course_code, course_name, course_description, 1, student_count, is_active
FROM course c
...
-- FALL 2024
INSERT INTO course (course_code, course_name, course_description, semester_id, student_count, is_active)
SELECT course_code, course_name, course_description, 3, student_count, is_active
FROM course c
WHERE c.semester_id = 2
  AND NOT EXISTS (
    SELECT 1 FROM course c2
    WHERE c2.course_code = c.course_code
      AND c2.semester_id = 3
);

-- SPRING 2025
INSERT INTO course (course_code, course_name, course_description, semester_id, student_count, is_active)
SELECT course_code, course_name, course_description, 4, student_count, is_active
FROM course c
WHERE c.semester_id = 2
  AND NOT EXISTS (
    SELECT 1 FROM course c2
    WHERE c2.course_code = c.course_code
      AND c2.semester_id = 4
);
...
INSERT INTO course_instructor (program_user_id, course_id, is_active)
SELECT ci.program_user_id, c_new.id, ci.is_active
FROM course_instructor ci
         JOIN course c_old ON ci.course_id = c_old.id
         JOIN course c_new ON c_new.course_code = c_old.course_code
    AND c_new.semester_id IN (1,3,4)
WHERE c_old.semester_id = 2
  AND NOT EXISTS (
    SELECT 1 FROM course_instructor ci2
    WHERE ci2.program_user_id = ci.program_user_id
      AND ci2.course_id = c_new.id
);

------------------------------------------------------------
-- 3) CLONE COURSE_INDICATOR
------------------------------------------------------------

INSERT INTO course_indicator (course_id, indicator_id, is_active)
SELECT c_new.id, ci.indicator_id, ci.is_active
FROM course_indicator ci
         JOIN course c_old ON ci.course_id = c_old.id
         JOIN course c_new ON c_new.course_code = c_old.course_code
    AND c_new.semester_id IN (1,3,4)
WHERE c_old.semester_id = 2
  AND NOT EXISTS (
    SELECT 1 FROM course_indicator ci2
    WHERE ci2.course_id = c_new.id
      AND ci2.indicator_id = ci.indicator_id
);

INSERT INTO student_outcome (out_number, out_value, out_description, evaluation, semester_id, is_active)
VALUES
    (1, NULL, 'Analyze a complex computing problem and apply computing principles to identify solutions.', NULL, 1, TRUE),
    (2, NULL, 'Design, implement, and evaluate a computing-based solution to meet a given set of computing requirements in the program’s discipline.', NULL, 1, TRUE),
    (3, NULL, 'Communicate effectively in a variety of professional contexts.', NULL, 1, TRUE),
    (4, NULL, 'Recognize professional responsibilities and make informed judgments in computing practice based on legal and ethical principles.', NULL, 1, TRUE),
    (5, NULL, 'Function effectively as a member or leader of a team engaged in activities appropriate to the discipline.', NULL, 1, TRUE),
    (6, NULL, 'Apply computer science theory and software development fundamentals to produce computing-based solutions.', NULL, 1, TRUE);

INSERT INTO student_outcome (out_number, out_value, out_description, evaluation, semester_id, is_active)
VALUES
    (1, NULL, 'Analyze a complex computing problem and apply computing principles to identify solutions.', NULL, 3, TRUE),
    (2, NULL, 'Design, implement, and evaluate a computing-based solution to meet computing requirements.', NULL, 3, TRUE),
    (3, NULL, 'Communicate effectively in a variety of professional contexts.', NULL, 3, TRUE),
    (4, NULL, 'Recognize professional responsibilities and make informed judgments based on ethical principles.', NULL, 3, TRUE),
    (5, NULL, 'Function effectively as a member or leader of a team.', NULL, 3, TRUE),
    (6, NULL, 'Apply computer science theory and software development fundamentals to produce solutions.', NULL, 3, TRUE);

INSERT INTO student_outcome (out_number, out_value, out_description, evaluation, semester_id, is_active)
VALUES
    (1, NULL, 'Analyze a complex computing problem and apply computing principles to identify solutions.', NULL, 4, TRUE),
    (2, NULL, 'Design, implement, and evaluate a computing-based solution to meet computing requirements.', NULL, 4, TRUE),
    (3, NULL, 'Communicate effectively in a variety of professional contexts.', NULL, 4, TRUE),
    (4, NULL, 'Recognize professional responsibilities and make informed judgments based on ethical principles.', NULL, 4, TRUE),
    (5, NULL, 'Function effectively as a member or leader of a team.', NULL, 4, TRUE),
    (6, NULL, 'Apply computer science theory and software development fundamentals to produce solutions.', NULL, 4, TRUE);

-- ============================
-- Fall 2023 – CS 101 (course_id = 9, 44 students)
-- course_indicator_ids: 38, 39, 40
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (38, 'CS 101 Ind 38 Meas 1 (Fall 2023)', NULL, NULL, NULL, 29, 5, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (38, 'CS 101 Ind 38 Meas 2 (Fall 2023)', NULL, NULL, NULL, 28, 5, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (38, 'CS 101 Ind 38 Meas 3 (Fall 2023)', NULL, NULL, NULL, 30, 7, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (39, 'CS 101 Ind 39 Meas 1 (Fall 2023)', NULL, NULL, NULL, 30, 5, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (39, 'CS 101 Ind 39 Meas 2 (Fall 2023)', NULL, NULL, NULL, 28, 5, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (40, 'CS 101 Ind 40 Meas 1 (Fall 2023)', NULL, NULL, NULL, 27, 7, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (40, 'CS 101 Ind 40 Meas 2 (Fall 2023)', NULL, NULL, NULL, 27, 5, 12, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (40, 'CS 101 Ind 40 Meas 3 (Fall 2023)', NULL, NULL, NULL, 29, 7, 8, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 201 (course_id = 10, 28 students)
-- course_indicator_ids: 47, 48, 49, 50, 51, 52, 53
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (47, 'CS 201 Ind 47 Meas 1 (Fall 2023)', NULL, NULL, NULL, 17, 4, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (47, 'CS 201 Ind 47 Meas 2 (Fall 2023)', NULL, NULL, NULL, 19, 3, 6, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (47, 'CS 201 Ind 47 Meas 3 (Fall 2023)', NULL, NULL, NULL, 19, 5, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (48, 'CS 201 Ind 48 Meas 1 (Fall 2023)', NULL, NULL, NULL, 18, 3, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (48, 'CS 201 Ind 48 Meas 2 (Fall 2023)', NULL, NULL, NULL, 19, 4, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (49, 'CS 201 Ind 49 Meas 1 (Fall 2023)', NULL, NULL, NULL, 17, 3, 8, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (49, 'CS 201 Ind 49 Meas 2 (Fall 2023)', NULL, NULL, NULL, 19, 4, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (49, 'CS 201 Ind 49 Meas 3 (Fall 2023)', NULL, NULL, NULL, 18, 4, 6, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (50, 'CS 201 Ind 50 Meas 1 (Fall 2023)', NULL, NULL, NULL, 17, 4, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (50, 'CS 201 Ind 50 Meas 2 (Fall 2023)', NULL, NULL, NULL, 18, 4, 6, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (51, 'CS 201 Ind 51 Meas 1 (Fall 2023)', NULL, NULL, NULL, 18, 3, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (51, 'CS 201 Ind 51 Meas 2 (Fall 2023)', NULL, NULL, NULL, 17, 4, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (52, 'CS 201 Ind 52 Meas 1 (Fall 2023)', NULL, NULL, NULL, 18, 3, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (52, 'CS 201 Ind 52 Meas 2 (Fall 2023)', NULL, NULL, NULL, 16, 4, 8, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (52, 'CS 201 Ind 52 Meas 3 (Fall 2023)', NULL, NULL, NULL, 17, 4, 7, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (53, 'CS 201 Ind 53 Meas 1 (Fall 2023)', NULL, NULL, NULL, 19, 3, 6, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (53, 'CS 201 Ind 53 Meas 2 (Fall 2023)', NULL, NULL, NULL, 18, 4, 6, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 330 (course_id = 11, 16 students)
-- course_indicator_ids: 68, 69
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (68, 'CS 330 Ind 68 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (68, 'CS 330 Ind 68 Meas 2 (Fall 2023)', NULL, NULL, NULL, 10, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (68, 'CS 330 Ind 68 Meas 3 (Fall 2023)', NULL, NULL, NULL, 9, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (69, 'CS 330 Ind 69 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (69, 'CS 330 Ind 69 Meas 2 (Fall 2023)', NULL, NULL, NULL, 9, 2, 5, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 335 (course_id = 12, 13 students)
-- course_indicator_ids: 74, 75, 76, 77
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (74, 'CS 335 Ind 74 Meas 1 (Fall 2023)', NULL, NULL, NULL, 8, 2, 3, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (74, 'CS 335 Ind 74 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 1, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (74, 'CS 335 Ind 74 Meas 3 (Fall 2023)', NULL, NULL, NULL, 7, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (75, 'CS 335 Ind 75 Meas 1 (Fall 2023)', NULL, NULL, NULL, 7, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (75, 'CS 335 Ind 75 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 1, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (76, 'CS 335 Ind 76 Meas 1 (Fall 2023)', NULL, NULL, NULL, 8, 1, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (76, 'CS 335 Ind 76 Meas 2 (Fall 2023)', NULL, NULL, NULL, 7, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (76, 'CS 335 Ind 76 Meas 3 (Fall 2023)', NULL, NULL, NULL, 8, 1, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (77, 'CS 335 Ind 77 Meas 1 (Fall 2023)', NULL, NULL, NULL, 7, 1, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (77, 'CS 335 Ind 77 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 1, 4, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 340 (course_id = 13, 15 students)
-- course_indicator_ids: 86
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (86, 'CS 340 Ind 86 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (86, 'CS 340 Ind 86 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (86, 'CS 340 Ind 86 Meas 3 (Fall 2023)', NULL, NULL, NULL, 9, 1, 5, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 360 (course_id = 14, 15 students)
-- course_indicator_ids: 89, 90, 91, 92, 93
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (89, 'CS 360 Ind 89 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (89, 'CS 360 Ind 89 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (89, 'CS 360 Ind 89 Meas 3 (Fall 2023)', NULL, NULL, NULL, 8, 1, 6, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (90, 'CS 360 Ind 90 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (90, 'CS 360 Ind 90 Meas 2 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (91, 'CS 360 Ind 91 Meas 1 (Fall 2023)', NULL, NULL, NULL, 8, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (91, 'CS 360 Ind 91 Meas 2 (Fall 2023)', NULL, NULL, NULL, 9, 1, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (91, 'CS 360 Ind 91 Meas 3 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (92, 'CS 360 Ind 92 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 1, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (92, 'CS 360 Ind 92 Meas 2 (Fall 2023)', NULL, NULL, NULL, 8, 2, 5, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (93, 'CS 360 Ind 93 Meas 1 (Fall 2023)', NULL, NULL, NULL, 9, 2, 4, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (93, 'CS 360 Ind 93 Meas 2 (Fall 2023)', NULL, NULL, NULL, 9, 1, 5, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 400 (course_id = 15, 27 students)
-- course_indicator_ids: 104–115
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (104, 'CS 400 Ind 104 Meas 1 (Fall 2023)', NULL, NULL, NULL, 15, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (104, 'CS 400 Ind 104 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (104, 'CS 400 Ind 104 Meas 3 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (105, 'CS 400 Ind 105 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (105, 'CS 400 Ind 105 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (106, 'CS 400 Ind 106 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (106, 'CS 400 Ind 106 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (106, 'CS 400 Ind 106 Meas 3 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (107, 'CS 400 Ind 107 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 2, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (107, 'CS 400 Ind 107 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (108, 'CS 400 Ind 108 Meas 1 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (108, 'CS 400 Ind 108 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (109, 'CS 400 Ind 109 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 2, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (109, 'CS 400 Ind 109 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (110, 'CS 400 Ind 110 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (110, 'CS 400 Ind 110 Meas 2 (Fall 2023)', NULL, NULL, NULL, 13, 3, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (111, 'CS 400 Ind 111 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (111, 'CS 400 Ind 111 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (112, 'CS 400 Ind 112 Meas 1 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (112, 'CS 400 Ind 112 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (113, 'CS 400 Ind 113 Meas 1 (Fall 2023)', NULL, NULL, NULL, 15, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (113, 'CS 400 Ind 113 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (114, 'CS 400 Ind 114 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 2, 11, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (114, 'CS 400 Ind 114 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (115, 'CS 400 Ind 115 Meas 1 (Fall 2023)', NULL, NULL, NULL, 14, 3, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (115, 'CS 400 Ind 115 Meas 2 (Fall 2023)', NULL, NULL, NULL, 15, 3, 9, 'Complete', TRUE);

-- ============================
-- Fall 2023 – CS 420 (course_id = 16, 25 students)
-- course_indicator_ids: 140, 141, 142
-- ============================

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (140, 'CS 420 Ind 140 Meas 1 (Fall 2023)', NULL, NULL, NULL, 13, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (140, 'CS 420 Ind 140 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 2, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (140, 'CS 420 Ind 140 Meas 3 (Fall 2023)', NULL, NULL, NULL, 13, 2, 10, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (141, 'CS 420 Ind 141 Meas 1 (Fall 2023)', NULL, NULL, NULL, 13, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (141, 'CS 420 Ind 141 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 2, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (142, 'CS 420 Ind 142 Meas 1 (Fall 2023)', NULL, NULL, NULL, 13, 3, 9, 'Complete', TRUE);

INSERT INTO measure (course_indicator_id, measure_description, observation, recommended_action, fcar, met, exceeded, below, m_status, is_active)
VALUES (142, 'CS 420 Ind 142 Meas 2 (Fall 2023)', NULL, NULL, NULL, 14, 3, 8, 'Complete', TRUE);


INSERT INTO performance_indicator (ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES (1, NULL, 'Student can correctly interpret a computational problem and define its parameters', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (1, NULL, 'Student can correctly interpret a computational problem and define its parameters', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (2, NULL, 'Student can analyze a computational problem in order to choose mathematical and algorithmic principles that can be applied to solve the problem', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (3, NULL, 'Student can define a solution to a computational problem', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (4, NULL, 'Student can effectively collect and document system requirements', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (5, NULL, 'Student can effectively analyze and model a problem domain', NULL, 7, 70.00, TRUE);

INSERT INTO performance_indicator
(ind_number, ind_value, ind_description, evaluation, student_outcome_id, threshold_percentage, is_active)
VALUES
    (6, NULL, 'Student can identify the relative efficiency of different algorithms using asymptotic notation', NULL, 7, 70.00, TRUE);
